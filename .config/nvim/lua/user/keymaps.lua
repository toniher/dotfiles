...
-- Snacks
keymap("n", "<leader>fb", "<cmd>lua require('snacks').picker.buffers()<CR>", desc_opts("Find buffers"))
keymap("n", "<leader>fd", "<cmd>lua require('snacks').picker.lsp_definitions()<CR>", desc_opts("Find LSP definitions"))
keymap("n", "<leader>fg", "<cmd>lua require('snacks').picker.grep()<CR>", desc_opts("Grep in project"))
keymap("n", "<leader>ff", "<cmd>lua require('snacks').picker.files({ hidden = true })<CR>", desc_opts("Find files"))
keymap("n", "<leader>fj", "<cmd>lua require('snacks').picker.jumps()<CR>", desc_opts("Find jumps"))
keymap("n", "<leader>fm", "<cmd>lua require('snacks').picker.marks()<CR>", desc_opts("Find marks"))
keymap("n", "<leader>fp", "<cmd>lua require('snacks').picker.projects()<CR>", desc_opts("Find projects"))
keymap("n", "<leader>fr", "<cmd>lua require('snacks').picker.recent()<CR>", desc_opts("Find recent files"))
keymap("n", "<leader>fs", "<cmd>AutoSession search<CR>", desc_opts("Find session"))
keymap("n", "<leader>ft", "<cmd>lua require('snacks').picker.todo_comments()<CR>", desc_opts("Find TODO comments"))
keymap("n", "<leader>fz", "<cmd>lua require('snacks').picker.zoxide()<CR>", desc_opts("Find directories with zoxide"))
...
-- Paths
keymap("n", "<leader>cw", "<cmd>lua print(vim.loop.cwd())<cr>", desc_opts("Print current working directory"))
...
keymap("n", "<leader>l1", function()
	require("user.lsp.mason").enable_all_lsp_servers()
...
keymap("n", "gD", "<cmd>lua vim.lsp.buf.declaration()<CR>", desc_opts("LSP: Go to declaration"))
keymap("n", "gd", "<cmd>lua vim.lsp.buf.definition()<CR>", desc_opts("LSP: Go to definition"))
keymap("n", "K", "<cmd>lua vim.lsp.buf.hover()<CR>", desc_opts("LSP: Hover"))
keymap("n", "gI", "<cmd>lua vim.lsp.buf.implementation()<CR>", desc_opts("LSP: Go to implementation"))
keymap("n", "gr", "<cmd>lua vim.lsp.buf.references()<CR>", desc_opts("LSP: Find references"))
keymap("n", "gl", "<cmd>lua vim.diagnostic.open_float()<CR>", desc_opts("LSP: Show diagnostics float"))
keymap("n", "<leader>la", "<cmd>lua vim.lsp.buf.code_action()<cr>", desc_opts("LSP: Code action"))
keymap("n", "<leader>lj", "<cmd>lua vim.diagnostic.goto_next({buffer=0})<cr>", desc_opts("LSP: Next diagnostic"))
keymap("n", "<leader>lk", "<cmd>lua vim.diagnostic.goto_prev({buffer=0})<cr>", desc_opts("LSP: Previous diagnostic"))
keymap("n", "<leader>lr", "<cmd>lua vim.lsp.buf.rename()<cr>", desc_opts("LSP: Rename symbol"))
keymap("n", "<leader>ls", "<cmd>lua vim.lsp.buf.signature_help()<CR>", desc_opts("LSP: Signature help"))
